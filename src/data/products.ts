...
export const products: Product[] = [
  {
    ...
    description:
      'A powerful and intuitive clipboard manager that transforms how you copy, organize, and access your clipboard history.',
    longDescription:
      'Clivy is a modern clipboard manager designed specifically for macOS users who want to boost their productivity. With its sleek dark interface and powerful search capabilities, Clivy makes managing your clipboard history effortless and efficient.',
    category: 'desktop',
    status: 'active',
  ...
  },
  {
    ...
    longDescription:
      'This portfolio website showcases modern web development practices with a focus on performance, accessibility, and beautiful design. Built with the latest technologies and deployed using GitHub Actions.',
    category: 'web',
    status: 'active',
