...
const Blog: React.FC = () => {
  ...
  const filteredPosts =
    selectedCategory === 'All'
      ? blogPosts
      : blogPosts.filter(post => post.tags.some(tag => tag.toLowerCase().includes(selectedCategory.toLowerCase())))
    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="section bg-gradient-to-br from-gray-800 to-gray-900">
        <div className="container mx-auto px-4 text-center">
          <h1 className="heading bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Blog</h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Thoughts on development, design, and technology. Sharing insights from my journey in creating software
            solutions.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map(post => (
              <article key={post.id} className="card hover:scale-105 transition-transform cursor-pointer">
                <div className="mb-4">
                  ...
                  <button className="text-blue-400 hover:text-blue-300 transition-colors font-medium" type="button">
                    Read More →
                  </button>
                </div>
              </article>
          ...
          <div className="max-w-md mx-auto">
            <div className="flex flex-col sm:flex-row gap-4">
              <input
                ...
                type="email"
              />
              <button className="btn btn-primary whitespace-nowrap" type="button">
                Subscribe
              </button>
            </div>
